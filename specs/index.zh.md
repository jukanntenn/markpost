...
| 文件                                                                   | 何时阅读                                                                                                                                                                                                                              |
| ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [auth.zh.md](./auth.zh.md)                                             | 端到端认证设计：JWT 双令牌（强化 HS256：锁定算法、强制 exp、密钥 ≥32B）、带令牌盗用重用检测的刷新令牌轮换（revoked 软标记）、GitHub OAuth 同页重定向（state + PKCE）、密码登录（bcrypt + NIST 800-63B）、登出、前端令牌存储与自动刷新 |
