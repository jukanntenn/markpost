    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v1.AdminSettingListResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1.AdminSetSettingRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1.AdminSetUserVIPRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/delivery/channels": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Channel kind, name, configuration and keywords",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/oauth/login": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "GitHub OAuth code and state",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/{id}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Response format (raw returns markdown)",
                        "name": "format",
                        "in": "query"
                    }
                ],
        ...
        "/{post_key}": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Post key used for authentication",
                        "name": "post_key",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "Post title and markdown body",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "v1.AdminSettingItem": {
            ...
            "properties": {
                ...
                "value": {
                    "$ref": "#/definitions/settings.SettingValue"
                }
            }
        },
        "v1.AdminSettingListResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1.AdminSettingItem"
                    }
                }
            }
        },
