...
#
# Usage:
#   # Build with default settings (tag: latest, registry: jukanntenn/markpost, local build for host platform)
#   ./build.sh
#
...
#   REGISTRY=myregistry/markpost ./build.sh
#
#   # Build with all custom options
#   IMAGE_NAME=markpost IMAGE_TAG=1.0.0 REGISTRY=myregistry PUSH=true PLATFORMS=linux/amd64,linux/arm64 ./build.sh
#
# Environment Variables:
#   IMAGE_NAME   - Image name (default: markpost)
...
IMAGE_NAME="${IMAGE_NAME:-markpost}"
