...
export function DashboardPage() {
  ...
  } = usePosts(1, undefined, { refetchInterval: 3000 })
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex shrink-0 items-center gap-1">
                    <Button
                      ...
                      title={
                        showKey ? tPostKey('hideKey') : tPostKey('showKey')
                      }
                    >
                      {showKey ? (
          ...
          <Card>
            <CardHeader className="flex-row items-center justify-between space-y-0">
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-base">{tDocs('title')}</CardTitle>
              </div>
            </CardHeader>
            <CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <QueryState
              isLoading={postsLoading}
              error={postsError}
              loadingText={tRecentPosts('loading')}
              errorText={tRecentPosts('error')}
            >
